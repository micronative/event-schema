...
class CreateTaskForUpdatedUser extends AbstractService implements RollbackInterface
{
    public function consume(AbstractEvent $event = null)
    {
        echo "Task has been created for updated user: {$event->getPayload()['name']}, {$event->getPayload()['email']}" . PHP_EOL;
